...
parser.add_argument("--data-dir", default=r'C:\Users\HP\Desktop\Yolov5_DeepSort_Track-master(自己改的，能用的)\deep_sort_pytorch\deep_sort\data', type=str)
...
def test(epoch):
    ...
    if acc > best_acc:
        best_acc = acc
        print("Saving parameters to checkpoint/ckpt_vn.t7")
        checkpoint = {
        ...
        if not os.path.isdir('checkpoint'):
            os.mkdir('checkpoint')
        torch.save(checkpoint, './checkpoint/ckpt_vn.t7')
