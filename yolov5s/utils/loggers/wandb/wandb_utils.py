...
from yolov5s.utils.dataloaders import LoadImagesAndLabels, img2label_paths
from yolov5s.utils.general import LOGGER, check_dataset, check_file
       ...
       """
        ...
        if isinstance(opt.resume, str):  # checks resume from artifact
            ...
            self.wandb_run = wandb.init(config=opt,
                                        ...
                                        entity=opt.entity,
                                        name=opt.name if opt.name != 'YOLOv5n特征图可视化' else None,
                                        job_type=job_type,
                                        id=run_id,
